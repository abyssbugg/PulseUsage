...
This is an independent repository. Maintainer and release rules are managed here, not in the original upstream project.

Release tags (`v*`) should only be created after build/test validation passes.
