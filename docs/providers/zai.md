...
PulseUsage is a GUI app. A one-off `export ...` in a terminal session will not be visible when you launch PulseUsage from
Spotlight/Launchpad. Persist it, then restart PulseUsage.
...
3. Enable the Z.ai plugin in PulseUsage settings
