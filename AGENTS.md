...
- On any plugin change/new plugin, audit plugin-exposed request/response fields against `src-tauri/src/plugin_engine/host_api/redaction.rs` redaction lists and add/update tests for gaps. Compare with existing plugins for patterns.
